...
// mrmIf.c
//
//   Functions to communicate over Ethernet, serial, or USB to an MRM
//
//
//_____________________________________________________________________________
...
static int mrmIfGetPacketIp(void *pkt, unsigned maxSize);
static int mrmIfGetPacketSerial(void *pkt, unsigned maxSize);
static int mrmIfSendPacketIp(void *pkt, unsigned size);
static int mrmIfSendPacketSerial(void *pkt, unsigned size);
...
//_____________________________________________________________________________
//
// mrmIfGetPacket - return MRM packet
//
...
//_____________________________________________________________________________
//
// mrmIfSendPacket - send packet out MRM interface
//
...
//_____________________________________________________________________________
//
// mrmIfTimeoutMsSet - set timeout for reads
//
//_____________________________________________________________________________
...
//_____________________________________________________________________________
//
// mrmIfFlush - flush any pending messages
//
//_____________________________________________________________________________
...
//_____________________________________________________________________________
//
// mrmIfGetPacketIp - read a packet from MRM using UDP
//
//_____________________________________________________________________________
...
//_____________________________________________________________________________
//
// mrmIfSendPacketIp - send a packet to the MRM using UDP
//
//_____________________________________________________________________________
...
static int serTimedRead(void *buf, int cnt)
{
#ifdef WIN32
    DWORD dwBytes = 0;
...
static int serWrite(void *buf, int cnt)
{
#ifdef WIN32
    DWORD dwBytes = 0;
...
//_____________________________________________________________________________
//
// mrmIfGetPacketSerial - read packet from serial port
//
//_____________________________________________________________________________
...
//_____________________________________________________________________________
//
// mrmIfSendPacketSerial - write packet to serial port
//
//_____________________________________________________________________________
...
static unsigned short crc16(void *ptr, int len)
{
    int i;
