...
GPS_override = false;
scan_incriment = 0;
if GPS_override            % (m) aperture length
%     aperture_length = 10;
%     scan_incriment = aperture_length/length(gps_data_m(:,1));
%     
%     numScans = length(gps_data_m(:,1));
%     
...
%     processScan(rawCollect, ovsFac, C_mps, rangeScaleFac);
    ...
    image_set = SAR_2D_Arbitrary_Aperture(rawCollect, sceneSize, display_image);
end 
