%% autoMonostaticCollect
% Initiates monostatic radar data collect at different spatial locations.

function [] = autoMonostaticCollect(numScans)
...
% Begin scanning and timing
fprintf('\n==============================\n')
fprintf('Press enter to begin scanning.\n')
pause
tic
...
for i=1:numScans
    ...
    fprintf('Press enter to continue scanning\n');
    pause;
