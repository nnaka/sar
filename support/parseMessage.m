function [str, msg_typ, msgID] = parseMessage(msg)

% MIT IAP 2013: Find a Needle in a Haystack
%
% Parse message according to Time Domain format.
%
% Inputs:
%   msg: raw message
%
% Outputs:
%   str: structure containing message payload
...
switch msg_typ
  ...
  case 'F201'
    ...
    str.scanData = repmat(int32(0),1,single(str.messageSamples));
